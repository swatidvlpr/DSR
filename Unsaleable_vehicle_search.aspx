<%@ Page Title="" Language="C#" MasterPageFile="~/DSR/DSR.master" AutoEventWireup="true" CodeFile="Unsaleable_vehicle_search.aspx.cs" Inherits="DSR_Unsaleable_vehicle_search" %>
...
<div class="col-md-6 form-group">
    ...
    <cc1:CalendarExtender ID="TextBox1_CalendarExtender" runat="server" 
        Enabled="True" TargetControlID="TextBox1" PopupPosition="TopRight">
...
<table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0">
        ...
        DataKeyNames="Unsale_id" CellPadding="4" 
