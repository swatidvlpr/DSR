...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   <script type="text/javascript">
       function validate() {
           var CustomerName = document.getElementById('<%=txtcustomernm.ClientID %>').value;           
           if (CustomerName == "") {
               alert("Enter Customer Name");
               document.getElementById('<%=txtcustomernm.ClientID %>').focus;
               return false;
           }                    
           ...
           if (document.getElementById('<%=ddlAccountCategory.ClientID%>').selectedIndex == 0)
            {
               alert("Enter Account Category");
               document.getElementById('<%=ddlAccountCategory.ClientID %>').focus;
               return false;
           }
           ...
           if (document.getElementById('<%=ddlmodelnm.ClientID%>').selectedIndex == 0)
           {
               alert("Select Model Name");
               document.getElementById('<%=ddlmodelnm.ClientID %>').focus;
               return false;
           }
           var Modelno = document.getElementById('<%=txtmodelno.ClientID %>').value;
           if (Modelno == "") {
               alert("Enter Model No");
               document.getElementById('<%=txtmodelno.ClientID %>').focus;
               return false;
           }
           if (document.getElementById('<%=ddlfleetsize.ClientID%>').selectedIndex == 0)
           {
               alert("Select Fleet Size");
               document.getElementById('<%=ddlfleetsize.ClientID %>').focus;
               return false;
           }
           var Unit = document.getElementById('<%=txtUnit_of_required.ClientID %>').value;
           if (Unit == "") {
               alert("Enter Unit Required");
               document.getElementById('<%=txtUnit_of_required.ClientID %>').focus;
               return false;
           }
           if (document.getElementById('<%=ddlemployee.ClientID%>').selectedIndex == 0)
           {
               alert("Select Sales Executive Name");
               document.getElementById('<%=ddlemployee.ClientID %>').focus;
               return false;
           }
           var Purchase = document.getElementById('<%=txtpurchaseplan.ClientID %>').value;
           if (Purchase == "") {
               alert("Enter Purchase Plan");
               document.getElementById('<%=txtpurchaseplan.ClientID %>').focus;
               return false;
           }
           if (document.getElementById('<%=ddlEnquirysource.ClientID%>').selectedIndex == 0)
           {
               alert("Enter Enquiry source");
               document.getElementById('<%=ddlEnquirysource.ClientID %>').focus;
               return false;
           }
           ...
           if (document.getElementById('<%=ddlbranch.ClientID%>').selectedIndex == 0)
           {
               ...
               else{alert("Please Checked Anyone");}        
         }
        </script>
        ...
        <div class="col-md-6 form-group">
          <label >Address </label>  
             <asp:TextBox ID="txtaddress" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>                
                <cc1:FilteredTextBoxExtender ID="txtaddress_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="UppercaseLetters" TargetControlID="txtaddress">
            </cc1:FilteredTextBoxExtender>
...
&nbsp;<asp:TextBox ID ="txtpincode" runat="server" CssClass="form-control" MaxLength="6"></asp:TextBox>
         ...
         <div class="col-md-6 form-group">
          ...
          <div class="col-md-6 form-group">
           ...
           <%-- <asp:TextBox ID="txtdate" runat="server" CssClass="form-control"></asp:TextBox>--%>
             <asp:DropDownList ID="ddlAccountCategory" runat="server" CssClass="form-control" ValidationGroup="a">
           ...
           <%-- <asp:TextBox ID="txtdate" runat="server" CssClass="form-control"></asp:TextBox>--%>
             <asp:DropDownList ID="ddllocation" runat="server" CssClass="form-control" AutoPostBack="True" OnDataBound="ddllocation_DataBound" OnSelectedIndexChanged="ddllocation_SelectedIndexChanged">
               ...
               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server"  
                    ControlToValidate="ddllocation" ErrorMessage=" Select location name" 
                ValidationGroup="a"></asp:RequiredFieldValidator>--%>
        </div>
         <div class="col-md-6 form-group">
       ...
       <div class="col-md-6 form-group">
        ...
        <div class="col-md-12 form-group">
            <asp:Button ID="Button1" runat="server" Text="SUBMIT" onclick="Button1_Click" Class=" btn btn-warning " OnClientClick="return validate();" />
